...
my %replacements = (
    ...
    DOUBLE_HORIZONTAL | DOUBLE_BOTTOM | TOP, DOUBLE_BOTTOM | DOUBLE_HORIZONTAL,
    ...
    HORIZONTAL | TOP | DOUBLE_BOTTOM, HORIZONTAL | DOUBLE_BOTTOM,
    HORIZONTAL | BOTTOM | DOUBLE_TOP, HORIZONTAL | DOUBLE_TOP,
    VERTICAL | RIGHT | DOUBLE_LEFT, VERTICAL | DOUBLE_LEFT,
    VERTICAL | LEFT | DOUBLE_RIGHT, VERTICAL | DOUBLE_RIGHT,
);
